...
var devConfig = {
    ...
    module: {
        loaders: [
        {
          ...
          loader: 'url-loader?limit=2048&name=[path][name].[ext]'
        }, {
          test: /\.(js|jsx)$/,
          loader: 'babel-loader',
          include: APP_PATH      
    ...
    resolve: {
      ...
      alias: {
        ...
        'react': path.join(Mod_PATH, 'react'),
        'react-dom': path.join(Mod_PATH, 'react-dom'),
        'react-redux': path.join(Mod_PATH, 'react-redux'),
        'redux': path.join(Mod_PATH, 'redux'),
        // 'react-bootstrap': path.join(Mod_PATH, 'react-bootstrap/dist/react-bootstrap.js'),
      }
    },
    plugins: [
